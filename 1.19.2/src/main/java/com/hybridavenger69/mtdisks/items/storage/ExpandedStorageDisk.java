package com.hybridavenger69.mtdisks.items.storage;
...
public class ExpandedStorageDisk extends Item implements IStorageDiskProvider {
    private static final String ID = "ID";

    public ExpandedStorageDisk() {
        super(new Item.Properties().tab(ModSetup.moreStorageTab).stacksTo(1));
    }
